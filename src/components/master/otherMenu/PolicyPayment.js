      ...
      <div className="container">
        <div className="pv-75">
          ...
          <div className="col-12">
            <p>
              {" "}
              Mahindra Foundation and Naandi Foundation is committed to
              protecting the privacy and security of your personal data. Your
              privacy is important to us. This notice provides you with
              information on how Mahindra Foundation and Naandi Foundation
              (“we”) will process your personal data as (i) a (potential) donor;
              and (ii) a user of our website.
            </p>
            <p>
              <b>1. Which of your data we process</b>
            </p>
            <p>
              Website visitors: In the course of your visit of this website we
              will automatically collect the following information:
            </p>
            <p>• The selected page on our website (URL)</p>
            <p>• Date and the time of your visit of this website</p>
            <p>• Your IP address</p>
            <p>• Name and version of your web browser</p>
            <p>
              • The website (URL) you have visited before you accessed this
              website
            </p>
            <p>• Certain cookies (see point 2 below)</p>
            <p>
              In case someone else uses the "tell a friend" feature on our
              website, or you send us a request via email we will process your
              name and email address.
            </p>
            <p>
              <b>Donors:</b> We collect personal data in course of your donation
              from you directly (name, email address, mailing address, company
              name, contact details), when you provide us with your personal
              data by donation to Project Hariyali.
            </p>
            <p>
              There is no obligation to provide the data that we ask you for.
              However, if you do not provide your personal data, you will not be
              able to make use of all the functions of this website or donate.
            </p>
            <p>
              <b>2. Cookies</b>
              This website uses so-called cookies. A cookie is a small file that
              may be installed on your computer when you visit a website.
              Cookies are generally used to provide site visitors with
              additional functionality within the site. They may for example be
              created to keep track of your visit and support your navigation of
              the website, help you resume where you left off and/or remember
              your preferences and settings when you visit the website again.
              Cookies cannot access, read or modify any other data on your
              computer.
            </p>
            <p>
              Most of the cookies used on this website are so-called session
              cookies. They are automatically deleted once you leave the
              website. On the other hand, persistent cookies remain on your
              computer until you delete them in your browser. We use persistent
              cookies to recognise you when you visit this website the next
              time.
            </p>
            <p>
              ...
              installed on your computer. Refer to the 'Help' function within
              your browser for more information on how to do these things.
            </p>
            <p>
            ...
            <p>
              <b>3. Purpose for which we process your data</b>
            </p>
            <p>
            ...
            <p>• To create website usage statistics</p>
            <p>
              • To be able to recognize, prevent and investigate attacks of this
              website
            </p>
            <p>• To communicate with you</p>
            <p>• To confirm incoming donations</p>
            <p>
              • To provide you with relevant information regarding our program
              (e.g. newsletters)
            </p>
            <p>
              • To ensure that your donation is used for the support of Hariyali
              project
            </p>
            <p>• To comply with obligations to public authorities</p>
            4. Legal basis of the processing We process your personal data
            provided by you either (i) on the basis of our prevailing legitimate
            interest according to Article 6 (1) (f) General Data Protection
            Regulation ("GDPR") to achieve the purposes set out above (ii) on
            the basis of the necessity for the performance of the contract we
            have concluded with you or to take steps at your request prior to
            entering into such an agreement (Article 6 (1) (b) GDPR) or (iii) on
            the basis of the necessity to comply with legal obligations to which
            we are subject (Article 6 (1) (c) GDPR). If we process your data on
            the basis of your consent (Article 6(1)(a) GDPR), we will ask for
            your consent in a separate process.
            <p>
              <b>5. Transfer of your personal data</b>
            </p>
            <p>
              As far as this is necessary for the purposes set out above, we
              will transfer your personal data to the following recipients:
            </p>
            <p>
              • Mahindra Foundation, (3rd Floor, Cecil Court Mahakavi Bhushan
              Marg Near Regal Cinema, Colaba Mumbai, Maharashtra -400001)
            </p>
            <p>• IT service providers</p>
            <p>• Public authorities (e.g. Income Tax Dept of India)</p>
            <p>
              Mahindra Foundation and Naandi Foundation are located in India
              which, according to the European Commission, does not provide an
              adequate level of data protection. We will therefore transfer your
              personal data to Mahindra Foundation and Naandi Foundation only as
              necessary for the administration of your donation (Article
              49(1)(b) GDPR).
            </p>
            <p>
              <b>6. Retention periods</b>
            </p>
            <p>
              We will retain your personal data for as long as we reasonably
              consider it necessary for achieving the purposes set out under
              Point 1 above and as is permissible under applicable law. We will,
              in any case, retain your personal data for as long as there are
              statutory retention obligations or potential legal claims are not
              yet time-barred.
            </p>
            <p>
              <b>7. Your rights in connection with your personal data</b>
            </p>
            <p>
              Under applicable law, you have, among others, the rights (under
              the conditions set out in applicable law)
            </p>
            <p>
              (i) to check whether and what kind of personal data we hold about
              you and to request copies of such data
            </p>
            <p>
              (ii) to request correction, supplementation or deletion of your
              personal data that is inaccurate or processed in non-compliance
              with applicable requirements
            </p>
            <p>
              (iii) to request us to restrict the processing of your personal
              data
            </p>
            <p>
              (iv) in certain circumstances, to object for legitimate reasons to
            ...
            <p>
              (vi) to know the identities of third parties to which your
              personal data are transferred
            </p>
            <p>(vii) to lodge a complaint with the competent authority.</p>
            <p>
              <b>8. Our contact details</b>
            </p>
            <p>
              Please address your requests or questions concerning the
              processing of your personal data to:
            </p>
            <p>The Mahindra Foundation</p>
            <p>
              Address – 3rd Floor, Cecil Court Mahakavi Bhushan Marg Near Regal
              Cinema, Colaba, Mumbai, Maharashtra - 400001
            </p>
            <p>Contact: support@hairyali.co.in</p>
            <p>The Naandi Foundation</p>
            <p>
              Address – 502, Trendset Towers, Road No. 2, Banjara Hills,
              Hyderabad,
            </p>
            <p>Telangana – 500 034</p>
            <p>Contact – support@hariyali.co.in</p>
            <p>
              <b>9. Changes to our Privacy Policy</b>
            </p>
            <p>
              Any material changes to the privacy policy will be posted on this
              page. The updated Privacy Policy will take effect as soon as it
              has been updated.
            </p>
            <p>
              I have read the above privacy policy and consent to share my data
              for the Hariyali project.
            </p>
          </div>
        </div>
      </div>
