      ...
      <Modal show={arakushow} onHide={ArakuClose}>
        ...
        <Modal.Body>
          <div class="program-details" closeButton>
            ...
            Araku Valley is located in the tribal region which is under the jurisdiction of the ITDA (Integrated Tribal Development Agency) Paderu falling in Alluri Sitharama Raju district, Andhra Pradesh, Southern India. We are working in 723 villages spread across 5 out of 11 mandals impacting over 1,20,000 farmer families. We have so far planted 16.40 million trees. (Plantation Season – Monsoon)
            </p>
          </div>
        </Modal.Body>
      </Modal>
      <Modal show={shravastishow} onHide={ShravastiClose}>
        ...
        <Modal.Body>
          <div class="program-details" closeButton>
            ...
            />
            <p className="footpop-p">Shravasti is situated 175 kms from the state capital Lucknow, Uttar Pradesh, Northern India. The 2018 NITI Aayog ranking puts it at fourth most backward district in India. We are currently working in 65 villages in Sirsia block. We have so far planted 2.96 lakh trees. (Plantation Season – Monsoon, Winter)
      ...
      <Modal show={solanshow} onHide={SolanClose}>
        ...
        <Modal.Body>
          <div class="program-details" closeButton>
            ...
            <p className="footpop-p">
            Solan district falls in Himachal Pradesh, Northern India. Solan is a predominantly a rural district with less than 20% of the population living in urban areas. The forest resources are experiencing severe stress with increasing pressure from the burgeoning population and rising impact of human commercial activities. We have so far planted 70,000 trees. (Plantation Season – Winter)
            </p>
          </div>
        </Modal.Body>
      </Modal>
      <Modal show={taranshow} onHide={TaranClose}>
        ...
        <Modal.Body>
          <div class="program-details" closeButton>
            ...
            <p className="footpop-p">
            Tarn Taran Sahib is a city in the state of Punjab, Northern India. The main occupation in this area is agriculture and agro industry with very few other industries. We are currently working in 50 villages in 3 tehsils. In Tarn Taran, 60% farmers belong to affirmative action category and 32% farmers belong to other backward classes. We have so far planted 2 lakh trees. (Plantation Season – Monsoon, Winter)trees have been planted.
      ...
      <Modal show={mogashow} onHide={MogaClose}>
        ...
        <Modal.Body>
          <div class="program-details" closeButton>
            ...
            <p className="footpop-p">
            Moga lies in the state of Punjab, Northern India. The total rural population is almost 80% and 20% being the urban population. We are currently working in 50 villages in 3 tehsils. In Moga, 60% farmers belong to affirmative action category and 32% farmers belong to other backward classes. We have so far planted 3.09 lakh trees. (Plantation Season – Monsoon, Winter)
            </p>
          </div>
        </Modal.Body>
      </Modal>
      <Modal show={wardhashow} onHide={WardhaClose}>
        ...
        <Modal.Body>
          <div class="program-details" closeButton>
            ...
            <p className="footpop-p">
            Wardha district is in the Vidarbha region, Maharashtra, Western India. Seventy-four percent of the population is residing in rural areas and 26% resides in urban areas. We are currently working in 22 villages across 4 tehsils. We have so far planted 1.25 lakh trees. (Plantation Season – Monsoon)
            </p>
          </div>
        </Modal.Body>
      </Modal>
