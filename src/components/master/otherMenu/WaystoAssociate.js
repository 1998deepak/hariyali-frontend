...
function WaystoAssociate() {
    ...
    const Individualsitems = [
        [
            ...
            { img: specialday, quote: "specialday", },
    ...
    return (
        <>
            ...
            <div className="">
                ...
                <div className="container">
                    <h3 className="text-center mtop-5 sub-title">On successful donation, every donor<br /> will receive a donation receipt and plantation reports</h3>
                    <ul className="row donor-benefits">
                        ...
                        <li className="col-12 col-sm-6 col-md-3 col-lg-2"><span className="bg-plantationreport"></span> Plantation Reports</li>
                            ...
                            <div className="tab-content" id="myTabContent">
                                <div className={`tab-pane fade ${activeTab === 'individual' ? 'show active' : ''}`}
                                    ...
                                    <div className=" donation-card-group">
                                        <p className=" text-center indu-p">As an individual, there are many ways you can associate with Project Hariyali.</p>
                                        <div className=" row justify-content-center group-content">
                                            ...
                                            <div className="col-12 col-md-3 donation-card-div">
                                                <div className="card h-100" >
                                                    ...
                                                    <div className="card-body tree-features1">
                                                        <h5 className="card-title">Commemorate an occasion</h5>
                                ...
                                <div className={`tab-pane fade ${activeTab === 'corporate' ? 'show active' : ''}`}
                                    ...
                                    <div className=" donation-card-group">
                                        <div className="feature-description">
                                            <h2 className="text-capitalize">A. Cause Related Marketing
                                            </h2>
