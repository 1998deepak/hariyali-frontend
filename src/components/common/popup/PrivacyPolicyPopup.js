...
export default function PrivacyPolicyPopup({ showConditons1, handleCloseConditions1 }) {
  return (
    <Modal
      size="lg"
      show={showConditons1}
      onHide={handleCloseConditions1}
      backdrop="static"
      keyboard={false}
    ...
    >
      ...
      <Modal.Footer>
        <Button variant="dark" onClick={handleCloseConditions1}>
          Close
        </Button>
      </Modal.Footer>
    </Modal>
