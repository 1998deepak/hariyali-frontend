...
import Donate from "./components/master/donation/Donate";
...
import OfflineDonationEdit from "./components/master/donation/OfflineDonationEdit";
import OfflineDonationPay from "./components/master/donation/OfflineDonationPay";
...
import OfflineDonation from "./components/master/admin/offlineDonation/OfflineDonation copy";
...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/Unauthorised"
        ...
        {/* <Route path="/Donate" element={<DonateWithHeaderAndFooter />} /> */}
 ...
 <Route path="/OfflineDonation"
        ...
        /> */}
         <Route path="/OfflineDonationEdit/:id?"
                element={
                  <ProtectedRoutes admin={authority.admin} user={authority.user}>
        ...
        /> */}
        <Route path="/OfflineDonationPay/:id?"
                element={
                  <ProtectedRoutes admin={authority.admin} user={authority.user}>
