...
function OfflineDonation() {
  ...
  const [numberOfBouquets, setNumberOfBouquets] = useState(false);
          ...
          donations: [
            {
              ...
              donationMode,
              donationEvent,
              totalAmount: generalDonation > 0 ? null : totalAmount,
              generalDonation,
  ...
  const calculateOverallTotal = () => {
    ...
    setTotalAmount(totalAmountOfPackage);
  };
              ...
              <Row className="justify-content-between bgwite border1 padding30 contact-form-wrap">
                ...
                <div className="col-12">
                  ...
                  >
                              ...
                              <div className="row select-label">
                                ...
                                <div className="col-8 p0">
                                  <input
                                    ...
                                    name="activity"
                                    // value="true"
                                    onClick={()=>setActivityType( "CSR Activity")}
                                  ...
                                  <input
                                    ...
                                    name="activity"
                                    // value="false"
                                    onChange={()=>setActivityType("NON-CSR Activity")}
                                    className="radioinput"
                                  />
                                ...
                                return <tr key={index}>
                                  ...
                                  <td>
                                    <input
                                      ...
                                      onChange={(event) => handleChangeNumberOfBouquets(event, packageItem, index)}
                                    />
                                  </td>
                    ...
                    <Tab eventKey="Gift A Plant" title="Gift a Plant" onClick={() => handleTabSelect('Gift a Plant')}>
