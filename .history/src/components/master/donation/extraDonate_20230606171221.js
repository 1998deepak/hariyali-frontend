...
function extraDonate() {
  ...
  return (
    <>
      {/* slider */}
      <div className="">
        <div className="slider-onheader">Donate with us</div>
          ...
          <Row className="justify-content-between postionindex">
            <div className="interested-in-contact">
              <div class="section-header text-center">
                <h6 class="mb-5">
                  <em>
                    Whether you’re a investor, dealer, Business professional or
                    an investor, you can find the best way to contact us from
                    the list below.
                  </em>
                </h6>
                      ...
                      <div className="row">
                        ...
                        <div className="col-12">
                          <div className="row select-label">
                            <div className="col-4 ">
                              {" "}
                              If Yes, Enter Valid PAN card No.
                            </div>
                            <input
                              className="col-8 form-control-inside"
